...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2024 at 07:20 PM
...
CREATE TABLE `kod` (
  ...
  `feltoltesi_ido` timestamp NULL DEFAULT NULL,
  `jovahagyott` tinyint(1) NOT NULL,
  `like_szam` int(10) UNSIGNED NOT NULL,
  `dislike_szam` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `kod` (`id`, `felhasznalo_id`, `kategoria_id`, `kod_eleresi_ut`, `feltoltesi_ido`, `jovahagyott`, `like_szam`, `dislike_szam`) VALUES
(1, 79, 1, './asd', '2024-12-19 18:16:26', 1, 12, 0);
...
ALTER TABLE `kod`
  ...
  ADD CONSTRAINT `kod_ibfk_3` FOREIGN KEY (`felhasznalo_id`) REFERENCES `felhasznalo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
