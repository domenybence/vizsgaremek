...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2025 at 03:30 PM
...
INSERT INTO `kod` (`id`, `felhasznalo_id`, `kategoria_id`, `nev`, `eleresi_ut`, `feltoltesi_ido`, `jovahagyott`, `kod_komment_id`) VALUES
(3, 30, 1, 'test', 'test', '2024-12-10 19:21:53', 1, NULL),
(4, 8, 1, 'teszt', 'teszt', '2024-12-30 19:30:28', 1, NULL);
