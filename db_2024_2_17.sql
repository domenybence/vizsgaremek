...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2025 at 09:24 PM
...
CREATE TABLE `felkeres` (
  ...
  `befejezesi ido` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `felkeres` (`id`, `nev`, `leiras`, `kod_id`, `feltoltesi_ido`, `jovahagyott`, `ar`, `felhasznalo_id`, `elvallalo_felhasznalo_id`, `befejezesi ido`) VALUES
(4, 'test', 'ddsasadsadsadadsadas', 5, '2025-02-17 18:55:02', 1, 200, 118, NULL, NULL);
