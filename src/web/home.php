...
<body class="bg-dark" style="color: white">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            <form class="d-flex" role="search">
              <input class="form-control me-2" type="search" placeholder="Szoftverkeresés" aria-label="Search">
  ...
  <div class="row">
    <div class="col my-sidebar">
      ...
      <hr>
      <form method="POST">
        <ul class="nav navbar-nav mr-auto nav-pills flex-column mb-auto" id="btncontainer">
          <li class="nav-item my-2">
            <button type="button" class="btn btn-default navbar-btn text-white">HTML</button>
          </li>
          <li class="nav-item my-2">
            <button type="button" class="btn btn-default navbar-btn text-white">CSS</button>
          </li>
          <li class="nav-item my-2">
            <button type="button" class="btn btn-default navbar-btn text-white">JS</button>
          </li>
          <li class="nav-item my-2">
            <button type="button" class="btn btn-default navbar-btn text-white">PHP</button>
          </li>
          <li class="nav-item my-2">
            <button type="button" class="btn btn-default navbar-btn text-white">C#</button>
          </li>
        </ul>
      </form>
      <?php
        include_once "../php_functions/adatbazis_lekeres.php";
