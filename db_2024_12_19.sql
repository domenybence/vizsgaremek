...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Dec 19. 11:53
...
--
-- Tábla szerkezet ehhez a táblához `felkeres_elvallal`
--
...
--
-- Tábla szerkezet ehhez a táblához `felkeres_teljesit`
--
...
INSERT INTO `kod` (`id`, `felhasznalo_id`, `kategoria_id`, `nev`, `feltoltesi_ido`, `jovahagyott`, `like_szam`, `dislike_szam`, `kod_komment_id`) VALUES
...
--
-- A tábla indexei `felkeres_elvallal`
--
...
--
-- A tábla indexei `felkeres_teljesit`
--
...
--
-- AUTO_INCREMENT a táblához `felkeres_elvallal`
--
ALTER TABLE `felkeres_elvallal`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT a táblához `felkeres_teljesit`
--
ALTER TABLE `felkeres_teljesit`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Megkötések a táblához `felkeres_elvallal`
--
ALTER TABLE `felkeres_elvallal`
